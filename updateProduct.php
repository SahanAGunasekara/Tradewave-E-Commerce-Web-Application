...
?>
        ...
        <head>
            ...
            <title>Tradewave | update product</title>
            ...
            <body class="">
                ...
                <div class="container fluid">
                    <div class=" justify-content-center col-12 col-lg-12">
                        ...
                        <h1 class="text-center">Complete Your listing</h1>
                        ...
                        <labelp class="form-label" for="firstname">Item title</label>
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <select class="form-select" id="category" disabled>
                                    <option value="0"><?php echo $category_data["cat_name"]; ?></option>
                            ...
                            <form>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="row mb-3 mt-3">
                                        <label for="Form-element" class="col-sm-2 col-form-label">Food Specigications - Trending</label>
                                        <div class="col-sm-10">
                                            <div class="col-md-4">
                                    ...
                                    <div class="row mb-3 mt-3">
                                        <label for="Form-element" class="col-sm-2 col-form-label">Allergence</label>
                                        <div class="col-sm-10">
                                            <div class="col-md-4">
                                    ...
                                    <div class="row mb-3 mt-3">
                                        <label for="Form-element" class="col-sm-2 col-form-label">Callories per srving</label>
                                        <div class="col-sm-10">
                                            <div class="col-md-4">
                                    ...
                                    <div class="row mb-3">
                                        <label for="Form-element" class="col-sm-2 col-form-label">Expiration Date </label>
                                        <div class="col-sm-10">
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" id="inputCity" placeholder="Enter your own">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 mt-3">
                                            <label for="Form-element" class="col-sm-2 col-form-label">Number of Servings</label>
                                            <div class="col-sm-10">
                                                <div class="col-md-4">
                                        ...
                                        <div class="row mb-3 mt-3">
                                            <label for="Form-element" class="col-sm-2 col-form-label">Serving Size</label>
                                            <div class="col-sm-10">
                                                <div class="col-md-4">
                                                    ...
                                                    Frequantly selected: 100Grams,40Grams
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="Form-element" class="col-sm-2 col-form-label">Calories per 100g/mL </label>
                                            <div class="col-sm-10">
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" placeholder="Enter your own">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3 mt-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="col-md-4">
                                                        <select class="form-select" id="color" disabled>
                                                            <?php
                                                ...
                                                <div class="row mb-3 mt-3">
                                                    <label for="colFormLabel" class="col-sm-2 col-form-label">Food Asia</label>
                                                    <div class="col-sm-10">
                                                        <div class="col-md-4">
                            ...
                            <div class="form-check col-12 col-lg-6">
                                <input class="form-check-input" type="radio" name="flexRadioDefault" id="b" checked disabled>
                                <label class="form-check-label" for="b">
                                    Brand New
                                </label>
                            </div>
                            <div class="form-check col-12 col-lg-6">
                                <input class="form-check-input" type="radio" name="flexRadioDefault" id="u" disabled>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input class="form-control" type="number" placeholder="Rs.<?php echo $product["price"]; ?>" id="cost" disabled>
                    ...
                    <div class="col-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <label class="form-label col-5" for="firstname" style="color:grey;">Buyer pays</label>
                                ...
                                <b style="color:grey;">Ship Within Country</b>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="d-grid gap-2 col-6 mx-auto">
                        <button class="btn btn-primary" style="border-radius: 20px;" type="button" onclick="addProduct();">List it</button>
                        <button class="btn btn-outline-secondary" style="border-radius: 20px;" type="button">Save for later</button>
                        <button class="btn btn-outline-secondary" style="border-radius: 20px;" type="button">Preview</button>
                    </div>
